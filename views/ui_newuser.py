...
################################################################################
## Form generated from reading UI file 'ui_newuser.ui'
##
...
class Ui_NewUserWindow(object):
    def setupUi(self, NewUserWindow):
        if not NewUserWindow.objectName():
            NewUserWindow.setObjectName(u"NewUserWindow")
        NewUserWindow.resize(700, 650)
        NewUserWindow.setStyleSheet(u"*{\n"
"	border: none;\n"
...
"}")
        self.verticalLayout = QVBoxLayout(NewUserWindow)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.centralwidget = QWidget(NewUserWindow)
    ...
    def retranslateUi(self, NewUserWindow):
        NewUserWindow.setWindowTitle(QCoreApplication.translate("NewUserWindow", u"Editar Usuario", None))
        self.label.setText(QCoreApplication.translate("NewUserWindow", u"Nuevo Usuario", None))
        self.label_nif.setText(QCoreApplication.translate("NewUserWindow", u"NIF", None))
        self.label_name.setText(QCoreApplication.translate("NewUserWindow", u"Nombre", None))
        self.label_email.setText(QCoreApplication.translate("NewUserWindow", u"Email", None))
        self.label_phone.setText(QCoreApplication.translate("NewUserWindow", u"Telefono", None))
        self.label_address.setText(QCoreApplication.translate("NewUserWindow", u"Direcci\u00f3n", None))
        self.btn_saveuser.setText(QCoreApplication.translate("NewUserWindow", u"Guardar", None))
        self.btn_cancel.setText(QCoreApplication.translate("NewUserWindow", u"Cancelar", None))
    # retranslateUi
