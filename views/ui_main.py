...
"}")
        ...
        self.separator = QWidget(self.mainBody)
        self.separator.setObjectName(u"separator")
        self.verticalLayout_2 = QVBoxLayout(self.separator)
        ...
        icon13 = QIcon()
        icon13.addFile(u"res/Icons/loader.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_updateInvoiceTable.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u"res/Icons/frown.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_deleteinvoice.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u"res/Icons/edit.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_editinvoice.setIcon(icon15)
